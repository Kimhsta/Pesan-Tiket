...
// Tentukan tarif jenis KA
$tarif_ka = ($jenis_ka == 'Ekonomi') ? 50000 : (($jenis_ka == 'Bisnis') ? 125000 : 275000);

// Tentukan tarif layanan makan
$tarif_makan = ($layanan_makan == 'Ya') ? 15000 : 0;

// Hitung subtotal dan diskon
$subtotal = $tarif_ka + $tarif_makan;
$diskon = ($jenis_ka == 'Eksekutif' && $layanan_makan == 'Ya') ? $subtotal * 0.15 : 0;
        ...
        <div class="card shadow-lg">
            ...
            <div class="card-body">
                ...
                <div class="text-center">
                    <a href="pesan.php" class="btn btn-primary">Input Lagi?</a>
                </div>
            </div>
        </div>
    </div>
